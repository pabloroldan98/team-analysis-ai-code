...
const TEXT: Record<Lang, Record<string, string>> = {
  es: {
    ...
    sell_rec_peak_desc: "Jugadores cuyo valor predicho es menor que su valor actual. Han alcanzado su máximo y se espera que pierdan valor.",
    sell_rec_decline: "Máxima caída de valor esperada",
    sell_rec_decline_desc: "Top 5 jugadores con mayor caída esperada (valor actual − predicho).",
    sell_rec_delta: "Caída esperada",
    sell_rec_select_all: "Seleccionar todos los que bajan",
    ...
    fair_price_help: "El precio justo se calcula con el modelo de la temporada anterior, prediciendo el valor a la fecha de inicio de la temporada actual.",
  ...
  en: {
    ...
    sell_rec_decline_desc: "Top 5 players with the largest expected decline (current value − predicted).",
    sell_rec_delta: "Expected drop",
    sell_rec_select_all: "Select all declining",
    ...
    fair_price_help: "Fair price is computed using the previous season's model, predicting the value at the current season start date.",
