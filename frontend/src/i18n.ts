...
const TEXT: Record<Lang, Record<string, string>> = {
  es: {
    ...
    sell_rec_select_all: "Seleccionar todos",
    ...
    objective_value_growth_help: "Maximiza la diferencia absoluta entre valor futuro y actual de cada jugador.",
    ...
    banned_clubs_help: "Clubes de los que no se puede fichar (separados por coma).",
    banned_clubs_placeholder: "Ej: Real Madrid, Manchester City",
    exclude_top_n: "Excluir top N clubes",
    exclude_top_n_help: "Excluir los N clubes más ricos como fuente de fichajes.",
    min_market_value_title: "Valor mínimo de mercado (€M)",
    min_market_value_help: "Solo considerar jugadores con valor superior a este umbral.",
    ...
    fair_price_help: "El precio justo es el valor predicho: punto de equilibrio para el comprador.",
  ...
  en: {
    ...
    sell_rec_select_all: "Select all",
    ...
    banned_clubs_help: "Clubs from which signings are not allowed (comma-separated).",
    banned_clubs_placeholder: "e.g. Real Madrid, Manchester City",
    exclude_top_n: "Exclude top N clubs",
    exclude_top_n_help: "Exclude the N richest clubs as signing sources.",
    ...
    fair_price_help: "Fair price is the player's predicted value: break-even point for the buyer.",
